  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-20">
      ...
      <div className="py-1 border-b border-gray-100">
        ...
        <p className="text-xs text-gray-400">Atur profil toko, informasi struk, dan tambahkan akun kasir staf</p>
      </div>
                ...
                <div key={kasir.id} className="p-3 bg-gray-50 rounded-xl flex items-center justify-between gap-3 border border-gray-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] text-gray-400">{kasir.email} • Kasir Staf</p>
                    </div>
                  </div>
      ...
      >
        <form onSubmit={handleAddKasir} className="space-y-3.5 text-xs">
          ...
          <Input
            ...
            type="email"
            placeholder="kasir.budi@tokiva.biz.id"
