    ...
    <div className="max-w-4xl mx-auto space-y-5 pb-24">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 py-1 border-b border-gray-100">
        <div>
          ...
          <p className="text-xs text-gray-400">Kelola daftar harga eceran/grosir & ambang stok minimum</p>
        </div>
        <button
        ...
        <form onSubmit={handleSave} className="space-y-3.5 text-xs">
          ...
          <div className="p-3 bg-gray-50 rounded-2xl border border-gray-200 space-y-2">
            <div className="flex items-center justify-between">
              ...
              <span className="text-[10px] text-[#16A34A] bg-emerald-50 px-2 py-0.5 rounded-full font-bold border border-emerald-100 flex items-center gap-1">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-1.5">
                <input
                  ...
                  className="w-full px-3 py-2 bg-white border border-gray-200 rounded-xl text-xs text-gray-700 placeholder:text-gray-400 focus:outline-none focus:border-[#16A34A]"
                />
                <button
                  type="button"
