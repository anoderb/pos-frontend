...
export default function AdminHeader({ title = 'Master Control Hub' }) {
  const { admin } = useAdminAuthStore();

  return (
    <header className="h-16 bg-slate-900/80 backdrop-blur-md border-b border-slate-800 px-6 flex items-center justify-between sticky top-0 z-30 text-slate-100">
