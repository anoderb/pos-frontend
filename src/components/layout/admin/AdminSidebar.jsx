...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-64 bg-slate-900 border-r border-slate-800 flex flex-col justify-between hidden md:flex shrink-0 min-h-screen text-slate-200 select-none">
      {/* Brand Header */}
      <div>
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <span className="font-bold text-base tracking-tight text-white block leading-none">
                Tokiva<span className="text-emerald-400">Admin</span>
              </span>
