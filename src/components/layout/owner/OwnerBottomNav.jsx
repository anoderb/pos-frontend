...
export default function OwnerBottomNav() {
  ...
  const ownerDrawerItems = [
    ...
    {
      label: 'Stock Opname',
      desc: 'Audit stok fisik 3-tahap vs sistem',
    ...
    },
    {
      ...
      desc: 'Retur barang rusak / kadaluarsa',
    ...
    {
      label: 'Konsinyasi',
      desc: 'Titip jual vendor & bagi hasil',
        ...
        <div className="bg-white/95 backdrop-blur-md border border-gray-100 shadow-xl rounded-2xl px-2 py-1.5 flex items-center justify-around relative">
          ...
          >
            <div
              className={cn(
                ...
                pathname === '/owner/dashboard' ? 'bg-emerald-50 text-[#16A34A]' : 'text-gray-400'
              )}
            >
            ...
            <span
              className={cn(
                ...
                pathname === '/owner/dashboard' ? 'text-[#16A34A]' : 'text-gray-400'
              )}
            >
              Dashboard
            </span>
          ...
          >
            <div
              className={cn(
                'p-1.5 rounded-xl transition-all duration-150',
                pathname === '/owner/produk' ? 'bg-emerald-50 text-[#16A34A]' : 'text-gray-400'
              )}
            >
            ...
            <span
              className={cn(
                'text-[10px] font-bold mt-0.5',
                pathname === '/owner/produk' ? 'text-[#16A34A]' : 'text-gray-400'
              )}
            >
              Produk
            </span>
          ...
          >
            <div
              className={cn(
                'p-1.5 rounded-xl transition-all duration-150',
                pathname === '/owner/laporan' ? 'bg-emerald-50 text-[#16A34A]' : 'text-gray-400'
              )}
            >
            ...
            <span
              className={cn(
                'text-[10px] font-bold mt-0.5',
                pathname === '/owner/laporan' ? 'text-[#16A34A]' : 'text-gray-400'
              )}
            >
              Laporan
            </span>
