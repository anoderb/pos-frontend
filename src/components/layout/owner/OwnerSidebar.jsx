  ...
  const menuGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Stock Opname 3-Tahap', href: '/owner/stock-opname', icon: ClipboardCheck },
      ],
    },
    {
      title: 'MITRA & RETUR',
      items: [
        { label: 'Return Supplier', href: '/owner/return-supplier', icon: RotateCcw },
        { label: 'Konsinyasi Titip Jual', href: '/owner/konsinyasi', icon: Handshake },
      ],
    },
    {
      title: 'SISTEM',
      ...
      <div className="flex-1 overflow-y-auto px-3 py-4 space-y-6">
        {menuGroups.map((group, idx) => (
          <div key={idx} className="space-y-1">
            <p className="px-3 text-[10px] font-bold text-gray-400 tracking-wider">
              {group.title}
            </p>
        ...
        <div className="p-3 bg-gray-50 rounded-2xl flex items-center justify-between">
          <div className="flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-[10px] text-gray-400 truncate">Owner Account</p>
            </div>
          </div>
          <button
