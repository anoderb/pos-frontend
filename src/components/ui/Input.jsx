    ...
    <div className="w-full space-y-1.5">
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          type={effectiveType}
          className={cn(
            'w-full px-3.5 py-2 text-sm bg-white border border-gray-200 rounded-xl transition-colors duration-150 focus:outline-none focus:border-[#16A34A] focus:ring-2 focus:ring-[#ECFDF5] placeholder:text-gray-400 text-gray-900',
            Icon && 'pl-9',
            prefix && 'pl-10',
        ...
        {isPasswordInput ? (
          <button
            ...
            className="absolute right-3 p-1 text-gray-400 hover:text-gray-600 rounded-lg transition-colors focus:outline-none"
